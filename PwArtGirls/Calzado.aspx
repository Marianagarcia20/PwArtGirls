<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Calzado.aspx.vb" Inherits="PwArtGirls.Calzado" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MainContent">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <center><asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="DK Lemon Yellow Sun" Font-Size="Medium" Text="&quot; C A L Z A D O &quot;"></asp:Label></center>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ArtGirlsConnectionString %>" SelectCommand="SELECT [id_prenda], [tallap], [preciop], [cantidadp], [descripcionp], [colorp], [imagenp] FROM [prenda] WHERE ([id_categoria] = @id_categoria)">
        <SelectParameters>
            <asp:Parameter DefaultValue="4" Name="id_categoria" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
    <br />
